...
INSERT INTO `book` (`BookID`, `BookTitle`, `OriginalTitle`, `YearofPublication`, `Genre`, `MillionsSold`, `LanguageWritten`, `AuthorID`, `BookCoverURL`) VALUES
(1, 'Don Quixote', 'El Ingenioso Hidalgo Don Quixote de la Mancha', 1605, 'Novel', 500, 'Spanish', 1, '..\\view\\images\\BookCovers\\DonQuixote.jpg'),
...
(9, 'She: A History of Adventure', 'She', 1886, 'FIction', 100, 'English', 8, '..\\view\\images\\BookCovers\\She.jpg'),
(10, 'The Lion, the Witch and the Wardrobe', 'The Lion, the Witch and the Wardrobe', 1950, 'Fantasy', 85, 'English ', 9, NULL);
...
INSERT INTO `userdetails` (`userID`, `username`, `password`, `role`, `firstName`, `lastName`, `email`) VALUES
(8, 'zachary', '$2y$10$Rme1eZDm0A467fMYz9ma2.ztah0SDoRvSE3T82pA0zYK1/dDultr2', 'User', 'zachary', 'cauchi', 'zachary@email.com');
